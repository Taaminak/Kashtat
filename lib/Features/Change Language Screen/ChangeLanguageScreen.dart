  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: SizedBox(
        ...
        child: Stack(
          children: [
            Positioned(right: context.locale.languageCode == 'en'? 0: null,left: context.locale.languageCode == 'ar'? 0: null,top: 0,child:  Image.asset(ImageManager.logoHalfGrey,height: size.height/2.5,).transformWidget(context),),
            Positioned.fill(
              child: Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 20),
                      Text(LocaleKeys.change_language.tr().capitalize(),style: TextStyle(
                            ...
                            Expanded(
                              child: Padding(
                                ...
                                child: ElevatedButton(
                                  ...
                                  onPressed: () {
                                    cubit.setLanguage(context, Locale('ar'));
                                  },
