  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Image.asset(
          ImageManager.logoWithTitleHWhite,
          height: 40,
        ),
        centerTitle: true,
        leading: SizedBox(),
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    // ),
                    SPMomeItem(
                      title: LocaleKeys.latest_reservations.tr(),
                      content: (cubit.providerTrips == null ||
                              cubit.providerTrips!.upcoming.isEmpty)
                          ? Center(
                              child: InkWell(
                                onTap: () {
                          ...
                          : Column(
                              children: [
                                for (int index = 0;
                                    index <
                                        cubit.providerTrips!.upcoming.length;
                                    index++)
                                  Padding(
                                    padding: EdgeInsets.only(
                                        bottom: cubit.providerTrips!.upcoming
                                                        .length -
                                                    1 ==
                                                index
                                            ? 0.0
                                          ...
                                          children: [
                                            Row(
                                              children: [
                                                ...
                                                Text(
                                                  '#${cubit.providerTrips?.upcoming[cubit.providerTrips!.upcoming.length - index - 1].id}',
                                                  style: TextStyle(
                                                      fontWeight:
                                                          FontWeightManager
                                                              .bold,
                    ...
                    SPMomeItem(
                      title: LocaleKeys.upcoming_guests.tr(),
                      content: (cubit.providerTrips == null ||
                              cubit.providerTrips!.upcoming.isEmpty)
                          ? Center(
                              child: Text(
                                LocaleKeys.no_upcoming_guests.tr(),
                                style: TextStyle(
                                  color: Colors.grey,
                                  fontSize: FontSize.s16,
                                  fontWeight: FontWeight.w500,
                                              ...
                                              child: Padding(
                                                ...
                                                child: Row(
                                                  children: [
                                                    ...
                                                    Text(
                                                      '${cubit.providerTrips?.upcoming[cubit.providerTrips!.upcoming.length - index - 1].user.name}',
                                                      style: TextStyle(
                                                          fontWeight:
                                                              FontWeightManager
                                                                  .bold,
                                              ...
                                              child: Padding(
                                                ...
                                                child: Row(
                                                  children: [
                                                    ...
                                                    Text(
                                                      '${(double.parse(cubit.providerTrips?.upcoming[cubit.providerTrips!.upcoming.length - index - 1].subtotal ?? "0.0") / double.parse(cubit.providerTrips?.upcoming[cubit.providerTrips!.upcoming.length - index - 1].unit.price!.others ?? "0.0")).toStringAsFixed(0)}',
                                                      style: TextStyle(
                                                          fontWeight:
                                                              FontWeightManager
                                                                  .bold,
                    ...
                    SPMomeItem(
                      title: LocaleKeys.latest_transfers.tr(),
                      content: (cubit.providerTrips == null ||
                              cubit.providerTrips!.upcoming.isEmpty)
                          ? Center(
                              child: Text(
                                LocaleKeys.no_transfers.tr(),
                                style: TextStyle(
                                  color: Colors.grey,
                                  fontSize: FontSize.s16,
                                  fontWeight: FontWeight.w500,
                              ...
                              child: Padding(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Text(
                                      '${LocaleKeys.riyal.tr()}${cubit.providerTrips?.upcoming.first.total}',
                                      style: TextStyle(
                                          fontWeight: FontWeightManager.bold,
                                          fontSize: 16),
                                    ),
                                    Spacer(),
                                    Text(
                                      '${cubit.providerTrips?.upcoming.first.unit.arrivalTime} ${cubit.providerTrips?.upcoming.first.arrivalDateTime}',
                                      style: TextStyle(
                    ...
                    SPMomeItem(
                        ...
                        content: Center(
                            child: Text(
                          '${(cubit.financialData.sales ?? 0.0).toStringAsFixed(2)} ${LocaleKeys.riyal.tr()}',
                          style: TextStyle(
                            fontWeight: FontWeight.bold,
                            fontSize: 18,
                          ),
                    ...
                    SPMomeItem(
                      title: LocaleKeys.receive_financial_amounts.tr(),
                      content: Center(
                        child: Text(
                          '${(cubit.financialData.netProfit ?? 0.0).toStringAsFixed(2)} ${LocaleKeys.riyal.tr()}',
                          style: TextStyle(
                            fontWeight: FontWeight.bold,
                            fontSize: 18,
                          ),
                    ...
                    SPMomeItem(
                        title: LocaleKeys.latest_ratings.tr(),
...
class SPMomeItem extends StatelessWidget {
  const SPMomeItem({Key? key, required this.title, required this.content})
      : super(key: key);
  final String title;
