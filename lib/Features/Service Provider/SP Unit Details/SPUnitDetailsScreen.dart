...
class SPUnitDetailsScreen extends StatelessWidget {
                ...
                children: [
                          ...
                          child: InkWell(
                            onTap: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => KashtaDetailsScreen(
                                            trip: cubit.selectedUnit,
                                            showButton: false,
                                          )));
                            },
                            child: Container(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: Text(
                                        LocaleKeys.preview_my_page.tr(),
                                        style: TextStyle(
                                            fontWeight:
                                                FontWeightManager.medium,
                                            fontSize: FontSize.s14,
                                            color:
                                                ColorManager.darkerGreyColor),
                                      ),
                                    )
                                  ],
                                ),
                  ...
                  ContainerDecorated(
                    ...
                    children: [
                      ...
                      MoreItemWidget(
                          title: 'الاعدادات',
                          hint: isNotCompleted(context) ? null : 'غير مكتمل',
                          img: ImageManager.settings,
                          onTap: () {
                  ...
                  Item(
                      ...
                      content: Row(
                        children: [
                          ...
                          Spacer(),
                          FaIcon(
                            !cubit.selectedUnit.isActive!
                                ? FontAwesomeIcons.solidEyeSlash
                                : FontAwesomeIcons.solidEye,
                            size: 15,
                            color: !cubit.selectedUnit.isActive!
                                ? ColorManager.redColor
                                : ColorManager.mintGreenColor,
                          ),
                          SizedBox(width: 5),
                          Padding(
                            padding: const EdgeInsets.only(top: 3.0),
                      ...
                      buttonTxt:
                          'تغيير الحالة إلى ${!cubit.selectedUnit.isActive! ? 'معروض' : 'غير معروض'}',
                      onTap: () {
                        cubit.updateUnitStatus(
                            status: !cubit.selectedUnit.isActive!,
                            unitId: cubit.selectedUnit.id!);
                      },
                      isLoading: state is UpdateUnitStatusLoadingState),
                  Item(
                    title: 'معلومات الكشتة',
                    content: Column(
                      ...
                      children: [
                        ...
                        Text(
                          cubit.selectedUnit.description ?? '',
                          style: TextStyle(
                              fontSize: FontSize.s14,
                              fontWeight: FontWeightManager.medium,
                              color: ColorManager.darkerGreyColor),
                    ...
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => AddNameAndDescriptionScreen(
                                  isUpdate: true,
                                  serviceName: cubit.getCategoryServiceName(
                                      cubit.selectedUnit.category?.id ?? -1,
                                      cubit.selectedUnit.subCategory!.id))));
                    },
                  ),
                  ...
                  Item(
                    ...
                    onTap: () {
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (context) =>
                                  const AddAddressScreen(isUpdate: true)));
                    },
                  ),
                  Item(
                    ...
                    content: Column(
                      ...
                      children: [
                        Text(
                          'اشبيلية, 6416 , الرياض 4007 السعودية',
                          style: TextStyle(
                              fontSize: FontSize.s14,
                              fontWeight: FontWeightManager.medium,
                              color: ColorManager.darkerGreyColor),
                      ...
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (context) => MapScreen(
                                  isUpdate: true,
                                  lat: cubit.selectedUnit.latitude ?? 0.0,
                                  long: cubit.selectedUnit.longitude ?? 0.0)));
                    },
                  ),
                  Item(
                    title: 'الصور',
                    content: Column(
                      ...
                      children: [
                        Text(
                          '${LocaleKeys.photos_count.tr()} ${cubit.selectedUnit.pics?.length ?? 0}',
                          style: TextStyle(
                              fontSize: FontSize.s14,
                              fontWeight: FontWeightManager.medium,
                              color: ColorManager.darkerGreyColor),
                        ...
                        Container(
                            ...
                            child: Padding(
                              ...
                              child: ListView.builder(
                                  itemCount:
                                      cubit.selectedUnit.pics?.length ?? 0,
                    ...
                    onTap: () {
                      Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) => AddNewUnitPhotosScreen(
                                isUpdate: true,
                              )));
                    },
                  ),
                  Item(
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            Spacer(),
                            Text(
                              cubit.selectedUnit.category?.name ?? '',
                              style: TextStyle(
                                  fontSize: FontSize.s14,
                                  fontWeight: FontWeightManager.medium,
                                  color: ColorManager.darkerGreyColor),
                    ...
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => AddNewUnitScreen(
                                    isUpdate: true,
                                  )));
                    },
                  ),
  ...
  bool isNotCompleted(BuildContext context) {
    final cubit = BlocProvider.of<AppBloc>(context);
    if (cubit.selectedUnit.instruction1!.isEmpty ||
