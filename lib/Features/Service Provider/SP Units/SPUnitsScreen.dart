                          ...
                          itemBuilder: (context, index) {
                            return ContainerDecorated(
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: Text(
                                        cubit.providerCategoriesWithUnits[index]
                                            .name,
                                        style: TextStyle(
                                ...
                                ListView.builder(
                                  itemCount: cubit
                                      .providerCategoriesWithUnits[index]
                                      .units
                                      .length,
                                  physics: const NeverScrollableScrollPhysics(),
                                  shrinkWrap: true,
                                                        ...
                                                        child: Column(
                                                          ...
                                                          children: [
                                                            ...
                                                            Row(
                                                              children: [
                                                                Text(
                                                                  '${cubit.providerCategoriesWithUnits[index].units[innerIndex].city?.name ?? 'الرياض'} - ${cubit.providerCategoriesWithUnits[index].units[innerIndex].state?.name ?? 'اشبيلية'}',
                                                                  style:
                                                                      TextStyle(
                                                                    fontSize:
                                                                        FontSize
                                                                ...
                                                                Text(
                                                                  '${LocaleKeys.units_count.tr()} ${cubit.providerCategoriesWithUnits[index].units.length}',
                                                                  style:
                                                                      TextStyle(
                                                                    fontSize:
                                                                        FontSize
                                                            ...
                                                            KButton(
                                                              onTap: () {
                                                                ...
                                                                cubit.setSelectedUnit(cubit
                                                                    ...
                                                                    .copyWith(
                                                                        category: CategoryModel(
                                                                            id: cubit.providerCategoriesWithUnits[index].categoryId,
                                                                            name: cubit.providerCategoriesWithUnits[index].name)));
                                                                    ...
                                                                    MaterialPageRoute(
                                                                        builder: (context) =>
                                                                            AddNameAndDescriptionScreen(
                                                                              serviceName: cubit.getCategoryServiceName(cubit.selectedUnit.category?.id ?? -1, cubit.selectedUnit.subCategory!.id),
                                                                            )));
                                                              },
                                                              title: LocaleKeys
                                                                  .add_unit_to_current_category
                                                                  .tr(),
                                                              width:
                                                                  MediaQuery.of(
                                                                          context)
                                                            ...
                                                            Row(
                                                              children: [
                                                                ...
                                                                const SizedBox(
                                                                    width: 30),
                                                                Text(
                                                                  '${LocaleKeys.unit_code.tr()} ${cubit.providerCategoriesWithUnits[index].units[innerIndex].id}',
                                                                  style:
                                                                      TextStyle(
                                                                    fontSize:
                                                                        FontSize
                        ...
                        Padding(
                          ...
                          child: SizedBox(
                              ...
                              child: KButton(
                                ...
                                title:
                                    LocaleKeys.add_new_category_location.tr(),
                                paddingV: 20,
                              )),
                        ),
                      ],
