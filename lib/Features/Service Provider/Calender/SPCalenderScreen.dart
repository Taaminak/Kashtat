...
class _SPCalenderScreenState extends State<SPCalenderScreen> {
  ...
  builder: (context, state) {
    final cubit = BlocProvider.of<AppBloc>(context);
    return state is ProviderCategoriesWithUnitsLoadingState? Center(child: Loader(),):SizedBox(
        ...
        child:Padding(
          ...
          child: Column(
            children: [
              Text(DateFormat.yMMMM('en_US').format(DateTime.now()) ,style: TextStyle(
                  ...
                  return Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        GridView.builder(
                            ...
                            itemBuilder: (BuildContext context, int innerIndex) {
                              return GestureDetector(
                                onTap: (){
                                  cubit.setSelectedUnit(cubit.providerCategoriesWithUnits[index].units[innerIndex]);
                                    ...
                                    Expanded(
                                      child: Container(
                                          ...
                                          decoration: BoxDecoration(
                                            ...
                                            color: ColorManager.mainlyBlueColorLight,
                                          ),
                                          child: Padding(
                                            padding: const EdgeInsets.all(20.0),
                                            child: Image.asset(ImageManager.calenderSP,color: ColorManager.mainlyBlueColor,fit: BoxFit.cover,),
                                          )),
                                    ),
                                    Padding(
                                      padding: const EdgeInsets.all(8.0),
                                      child: Text(cubit.providerCategoriesWithUnits[index].units[innerIndex].name??'',style: TextStyle(
                        ...
                        if(index != cubit.providerCategoriesWithUnits.length-1)
                        Divider(thickness: 2.0,color: ColorManager.greyColor,)
                      ],
                    ),
                  );
                }),
