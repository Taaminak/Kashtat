...
class KButton extends StatefulWidget {
  const KButton({super.key, required this.onTap, required this.title, this.width = 130, this.paddingH = 15, this.paddingV = 8, this.clr = const Color(0xff482383), this.txtClr = Colors.white, this.icon, this.hasBorder = false, this.isLoading = false});
          ...
          child: ElevatedButton(
            style:ButtonStyle(
              ...
              side: MaterialStateProperty.resolveWith<BorderSide>(
                      (states) => BorderSide(color:widget.hasBorder? widget.txtClr: widget.clr)),
            ),
