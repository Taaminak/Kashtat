...
class AddNameAndDescriptionScreen extends StatefulWidget {
  const AddNameAndDescriptionScreen(
      {super.key, required this.serviceName, this.isUpdate = false});
  final String serviceName;
  final bool isUpdate;

  @override
  State<AddNameAndDescriptionScreen> createState() =>
      _AddNameAndDescriptionScreenState();
}

class _AddNameAndDescriptionScreenState
    extends State<AddNameAndDescriptionScreen> {
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                '${LocaleKeys.service_name.tr()} ${widget.serviceName}',
                                style: TextStyle(
                                  fontSize: 16,
                              ...
                              Text(
                                cubit.unitBody.subCategoryId == 8
                                    ? LocaleKeys.chef_description.tr()
                                    : LocaleKeys.property_description.tr(),
                              ...
                              Text(
                                cubit.unitBody.subCategoryId == 8
                                    ? LocaleKeys.write_distinctive_description
                                        .tr()
                                    : LocaleKeys.write_distinctive_description
                                        .tr(),
                                textAlign: TextAlign.right,
                          ...
                          onTap: () async {
                            ...
                            if (controller.text.isEmpty &&
                              ...
                              final snackBar = SnackBar(
                                content: Center(
                                  child: Text(
                                    LocaleKeys.please_enter_description_and_name
                                        .tr(),
                            ...
                            cubit.updateNewUnitDescription(
                                desc: controller.text,
                                name: controllerName.text);
                            if (widget.isUpdate) {
                              await cubit
                                  .updateUnitNameAndDetails(
