...
class UsageTermsScreen extends StatefulWidget {
  const UsageTermsScreen({super.key});

  @override
  State<UsageTermsScreen> createState() => _UsageTermsScreenState();
}

class _UsageTermsScreenState extends State<UsageTermsScreen> {
  @override
