  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          LocaleKeys.bank_account_settings.tr(),
        ...
        child: Padding(
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                TitleWidget(txt: LocaleKeys.select_bank.tr()),
                Container(
                      ...
                      child: ButtonTheme(
                        ...
                        child: DropdownButton<String>(
                          ...
                          onChanged: (String? newValue) {
                            ...
                            print('=========================');
                            setState(() {
                              dropdownValue = (cubit.allBanks.firstWhere(
                                  (element) => element.name == newValue)).name!;
                ...
                TitleWidget(txt: LocaleKeys.account_holder_name.tr()),
                SizedBox(
                  height: 10,
                ),
                TextFieldWidget(
                    hint: LocaleKeys.write_account_holder_name.tr(),
                    controller: nameHolderController),
                SizedBox(
                  height: 20,
                ),
                TitleWidget(txt: LocaleKeys.iban_number.tr()),
                SizedBox(
                  height: 10,
                ),
                Directionality(
                  ...
                  child: TextFieldWidget(
                      hint: 'SA', hasPrefix: true, controller: ipanController),
                ),
                SizedBox(
                  height: 40,
                ),
                BlocConsumer<AppBloc, AppState>(
                  listener: (context, state) {
                    if (state is CreateNewBankAccountLoadingState) {
                      Fluttertoast.showToast(
                          msg: LocaleKeys.account_added_successfully.tr(),
                    ...
                    if (state is CreateNewBankAccountFailureState) {
                      Fluttertoast.showToast(
                          msg: LocaleKeys.account_added_failed.tr(),
                          toastLength: Toast.LENGTH_SHORT,
                          gravity: ToastGravity.BOTTOM,
                          timeInSecForIosWeb: 1,
                  ...
                  builder: (context, state) {
                    return KButton(
                      onTap: () {
                        cubit.createNewBankAccount(
                            name: nameHolderController.text,
                            iban: ipanController.text,
                            bankId: bankId);
                      },
                      title: LocaleKeys.save.tr(),
                      width: size.width,
                      paddingV: 15,
                      isLoading: state is CreateNewBankAccountLoadingState,
                    );
                  },
                ),
                const SizedBox(
        ...
        child: Padding(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
                ...
                filled: true,
                hintStyle:
                    TextStyle(color: Colors.grey[400], fontSize: FontSize.s12),
