...
class AccountExplanationScreen extends StatefulWidget {
  ...
  @override
  State<AccountExplanationScreen> createState() => _AccountExplanationScreenState();
}
                ...
                child: Padding(
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        if(state is FinancialSummaryLoadingState ||state is RatingSummaryLoadingState )
                              ...
                              child: Center(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      (cubit.financialData.reservationsCount??'').toString(),
                                      style: TextStyle(
                                        fontSize: FontSize.s18,
                                        fontWeight: FontWeightManager.bold,
                                      ),
                        ...
                        SizedBox(height: 10),
                        ContainerDecorated(
                          content: cubit.financialData.reservations == null?Row(
                            children: [
                            ],
                          ):ToggleList(
                            shrinkWrap: true,
