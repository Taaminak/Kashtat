...
class KashtaDetailsScreen extends StatefulWidget {
  const KashtaDetailsScreen(
      {Key? key, required this.trip, this.showButton = true})
      : super(key: key);
  ...
  List<String> getDaysInBetween(DateTime startDate, DateTime endDate) {
    ...
    for (int i = 0; i <= endDate.difference(startDate).inDays; i++) {
      Intl.withLocale("en_US", () {
        days.add(
            DateFormat('y-MM-dd').format(startDate.add(Duration(days: i))));
      });
    }
    return days;
  }
    ...
    return Scaffold(
      body: SizedBox(
        ...
        child: Column(
          children: [
            const Material(
                elevation: 5, child: HeaderWidget(allowToBack: true)),
            Expanded(
              child: ExpandableBottomSheet(
                        ...
                        Padding(
                          ...
                          child: ContainerDecorated(
                            ...
                            children: [
                              if (widget.showButton)
                                Row(
                                  children: [
                                    ...
                                    Text(
                                      '  ( ${cubit.selectedDates.length} ${LocaleKeys.nights_count.tr()})',
                                      style: TextStyle(
                                        fontSize: FontSize.s14,
                                        fontWeight: FontWeightManager.medium,
                                      ),
                              ...
                              if (widget.showButton) SizedBox(height: 20),
                              if (widget.showButton)
                                Row(
                                  children: [
                                    Expanded(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            cubit.selectedDates.isEmpty
                                                ? LocaleKeys.no_date.tr()
                                                : DateFormat(
                                                        "EEEE, MMM d, yyyy")
                        ...
                        SizedBox(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(
                                  LocaleKeys.booking_conditions.tr(),
                                  style: TextStyle(
                                    fontSize: FontSize.s16,
                                    fontWeight: FontWeightManager.bold,
                                  ),
                                ...
                                Padding(
                                  padding: const EdgeInsets.symmetric(
                                      horizontal: 10),
                                  child: Text(
                                    widget.trip.instruction1.toString(),
                                    style: TextStyle(
                                        fontSize: FontSize.s16,
                                        fontWeight: FontWeightManager.medium,
                                        color: ColorManager.blackColor
                                ...
                                Padding(
                                  padding: const EdgeInsets.symmetric(
                                      horizontal: 10),
                                  child: Text(
                                    widget.trip.instruction2.toString(),
                                    style: TextStyle(
                                        fontSize: FontSize.s16,
                                        fontWeight: FontWeightManager.medium,
                                        color: ColorManager.blackColor
                ...
                persistentHeader: !widget.showButton
                    ? SizedBox()
                    : Container(
                        height: 40,
                        decoration: BoxDecoration(
                ...
                expandableContent: !widget.showButton
                    ? SizedBox()
                    : Container(
                        // height: 500,
                        color: ColorManager.whiteColor,
                                        ...
                                        children: [
                                          Expanded(
                                            child: Column(
                                              ...
                                              children: [
                                                Text(
                                                  '${calculatePrice(cubit.selectedDates, trip.price ?? Price()).average} ${LocaleKeys.per_night.tr()}',
                                                  style: TextStyle(
                                                      fontSize: FontSize.s12,
                                                      fontWeight:
                                                          FontWeightManager
                                                ...
                                                Text(
                                                  '${LocaleKeys.total_nights.tr()} ${cubit.selectedDates.length} ${LocaleKeys.nights_count.tr()} ${calculatePrice(selectedDates, trip.price ?? Price()).total + (calculatePrice(selectedDates, trip.price ?? Price()).total * 0.15)} ر.س',
                                                  style: TextStyle(
                                                      fontSize: FontSize.s12,
                                                      fontWeight:
                                                          FontWeightManager
                  ...
                  if (_dates.length == 1) {
                    ...
                    setState(() {
                      selectedDates = getDaysInBetween(
                          _dates.first ?? DateTime.now(),
                          _dates.last ?? DateTime.now());
                    });
                  }
